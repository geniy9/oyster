...
// const items = [...Array(props.qty).keys()].map(i => `/img/team/${props.service}_${i + 1}.jpg`);
const items = [...Array(props.qty).keys()].map(i => `/img/team/${props.service}_1.jpg`);
...
<template>
  <div class="flex flex-col items-center justify-center gap-2">
    <UCarousel ref="carousel" :items="items" v-slot="{ item, index }" loop class="max-w-60">
